            ...
            <div className="container w-11/12 lg:w-full">
                ...
                <div className='p-4'>
                    ...
                    <form action="">
                        ...
                        <div className='my-6 md:my-0 basis-1/2'>
                        ...
                        <div className='my-6 md:flex'>
                            ...
                            <input checked type="radio" name="payment" id="cash" className='selection:bg-primary'/><label htmlFor="cash" className='ml-4'>Cash on Delivery</label>
                            </div>
                            </div>
                        </div>
                ...
                <div className='p-4'>
                    ...
                    <button className='block w-full py-5 px-10 bg-primary text-white tracking-wider'>PLACE ORDER</button>
                </div>
                </div>
            </div>
        </div>
